...
{
    private const string DedicatedServerScene = "Assets/Scenes/DedicatedServerScene.unity";
    private const string MultiInstanceServerScene = "Assets/Scenes/MultiInstanceServerScene.unity";
